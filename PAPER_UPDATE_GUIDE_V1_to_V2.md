...
#### 📌 অপশন ১: যদি Appendix/Supplementary-তে দেন (সবচেয়ে স্ট্যান্ডার্ড)

মূল পেপারের **Section 4.4**-এ শুধু **Table 5** থাকবে। টেবিল ৫ পুরো বাংলাদেশের বিভাগীয় গড় (division-wise mean) খুব সুন্দরভাবে উপস্থাপন করে। আর বিস্তারিত স্টেশন-ভিত্তিক চিত্রগুলোকে আপনারা Appendix-এ রেফার করে দিবেন।

সেক্ষেত্রে মূল টেক্সটের **Seasonal Analysis** অংশে (Line 1390-1393) শুধু এই লাইনটি যুক্ত করে দেবেন:

> *"...Pre-monsoon months (March-May) were most vulnerable due to high temperatures and low precipitation. The detailed station-wise seasonal and monsoon phase drought frequencies are provided in **Supplementary Figures S1 and S2**, respectively."*

---

#### 📌 অপশন ২: যদি মূল পেপারের Section 4.4-এ প্লেস করতে চান

যদি আপনারা চিত্র দুটি পেপারেই রাখতে চান, তবে এগুলোকে **Section 4.4** এর ভেতরে **Table 5** এর ঠিক নিচে এবং **Figure 13 (Decadal Trends)** এর ওপরে প্লেস করতে হবে।

যেহেতু আপনাদের চিত্র দুটি আলাদা ফাইল, সেগুলোকে নিচে ক্যাপশন সহ ম্যানুস্ক্রিপ্টে এভাবে লিখবেন:

```markdown
**Table 5:** Regional Drought Vulnerability by division with frequency and severity.
... (Table 5 content here) ...

![Station-Wise Agricultural Season Drought Frequencies](/home/alamin/Documents/DroughtClassificationTest/figs/figure_10_v2_agricultural_seasons_stationwise.png){width="6.5in"}
**Figure 11:** Station-Wise Agricultural Season Drought Frequencies in Bangladesh showing mean drought frequency (%) across Boro, Aus, and Aman crop seasons (1961-2023).

![Station-Wise Monsoon Phase Drought Frequencies](/home/alamin/Documents/DroughtClassificationTest/figs/figure_10b_v2_monsoon_phases_stationwise.png){width="6.5in"}
**Figure 12:** Station-Wise Monsoon Phase Drought Frequencies in Bangladesh across Dry Season, Pre-Monsoon, Peak Monsoon, and Post-Monsoon phases (1961-2023).
```

*নোট: যদি আপনারা এই চিত্র দুটিকে মূল বডিতে যুক্ত করেন, তবে পূর্ববর্তী মেসেজে আমি যে **Figure Numbering**-এর প্রস্তাবিত তালিকা দিয়েছিলাম, সেটি আরেকটু আপডেট হবে। নতুন চিত্র দুটির কারণে পরবর্তী চিত্রগুলোর নম্বর আরও ২ ধাপ এগিয়ে যাবে (যেমন: Decadal Trends হয়ে যাবে Figure 15, Accuracy Map হয়ে যাবে Figure 16)।*
